...
import { Building2, AlertTriangle, RefreshCw, ArrowLeft } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="space-y-2">
          <h1 className="text-xl font-bold text-foreground">Couldn&apos;t load properties</h1>
          <p className="text-muted-foreground text-sm">
            There was a problem fetching property listings. Please try again.
          </p>
          {error.digest && (
